<?php   $scrpt_vrsn_dt  = 'webcam_c_block.php|01|2020-12-02|';  # release 2012_lts
#
...
if ('replace wiht link'  == $webcam_img) {$webcam_img = './img/camplus.jpg';}
$extra  = '';
...
elseif ($click_large === 'image')
     {  echo '<a href="image_popup.php?nr=wcam1" data-featherlight="iframe" title="WEATHERSTATION WEBCAM">'.PHP_EOL;}  

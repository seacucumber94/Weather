<?php $scrpt_vrsn_dt  = 'PWS_wuhistory.php|01|2021-05-16|'; # beta release 2012_lts
#-----------------------------------------------
...
#
if ($uvsolarsensors =='both' || $uvsolarsensors = 'darksky')
     {  $showSolar = true; } else { $showSolar = false;}  $showSolar = false;
#
$ws_commontemp_type = strtolower($temp_his);		
...
#
$script = $wu_fldr.'WU-History4.php'; 
...
'<a href="https://www.wunderground.com/personal-weather-station/dashboard?ID='.$wuid.'" target="_blank"> Weather Underground</a>. '
.langtransstr ('Original script by')
.'&nbsp;<a href="http://jcweather.us/scripts.php" target="_blank">Jim McMurry</a>. '
.langtransstr ('Rewritten for template use')
.'&nbsp;<a href="https://support.leuven-template.eu" target="_blank">Leuven-Template</a></small></h3>
</div>'.PHP_EOL;
#echo '</div>'.PHP_EOL;
echo ws_css_insert ($wu_fldr.'styleHist.css',true);
ws_debug_info(); 

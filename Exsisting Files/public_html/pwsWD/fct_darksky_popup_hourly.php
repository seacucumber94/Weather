<?php  $scrpt_vrsn_dt  = 'fct_darksky_popup_hourly.php|01|2023-02-15|';  #  switch to Pirate weather & VirtualCrossing + PHP 8.1 + release 2012_lts
#-----------------------------------------------
#                                script settings
#-----------------------------------------------
...
include_once $scrpt; 
#
if (!isset ($darkskyhourlyCond) || count ($darkskyhourlyCond) < 8 )   
...
'.$close
.'      <span style="color: '.$color.'">'.$darkskyhourlySummary.'</span>
    </div>'.PHP_EOL;

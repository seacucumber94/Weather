<?php   # $scrpt_vrsn_dt  = 'moon.php|01|2020-11-06';  # release 2012_lts    
###### https://dxprog.com/entry/calculate-moon-rise-and-set-in-php
/******************************************************************************
...
class Moon {
	...
	public static function calculateMoonTimes($month, $day, $year, $lat, $lon) {
		...
		$timezone = round(date('Z')/3600,1);        # $timezone = 0; #(int)($lon / 15);

<?php  # $scrpt_vrsn_dt  = 'MoonPhase.php|01|2020-11-04|';  # release 2012_lts 
/**
...
$result['sundistance']          = $moon->sundistance();
$result['new_moon']             = $moon->new_moon();
$result['next_new_moon']        = $moon->next_new_moon();
$result['full_moon']            = $moon->full_moon();
$result['next_full_moon']       = $moon->next_full_moon();
$result['first_quarter']        = $moon->first_quarter();
$result['next_first_quarter']   = $moon->next_first_quarter();
$result['last_quarter']         = $moon->last_quarter();
$result['next_last_quarter']    = $moon->next_last_quarter();
$result['phase_name']           = $moon->phase_name();
